...
animate_viz <- animate(plastic_viz_animate, fps = 20, duration = 15, start_pause = 30, end_pause = 60, height = 600, width = 650)

animate_viz

anim_save("plastic_viz_draft.gif", animate_viz)
```
